...
try:
    ...
    START_BTN2_URL = 'https://t.me/Technical_Help_Support_Bot'
try:
...
try:
    ...
    if len(AUTHOR_URL) == 0:
        AUTHOR_URL = 'https://t.me/Technical_Help_Support_Bot'
except KeyError:
    AUTHOR_URL = 'https://t.me/Technical_Help_Support_Bot'
try:
...
try:
    ...
    if len(GD_INFO) == 0:
        GD_INFO = 'Uploaded by AMROBOTS SERVER'
except KeyError:
    GD_INFO = 'Uploaded by AMROBOTS SERVER'
try:
...
try:
    ...
    IMAGE_URL = 'https://telegra.ph/file/7e56d907542396289fee4.jpg'
try:
